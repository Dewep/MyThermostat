  ...
  if (!state) {
    try {
      state = {
        ...
        programs: [
          { hours: 1, minutes: 30, temperature: 180 },
          { hours: 7, minutes: 45, temperature: 200 },
          { hours: 8, minutes: 10, temperature: 205 },
          { hours: 9, minutes: 15, temperature: 180 },
          { hours: 17, minutes: 30, temperature: 200 },
          { hours: 18, minutes: 0, temperature: 205 }
        ],
        manualUntil: null
      }
